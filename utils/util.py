...
def minimize_mask(bbox, mask, mini_shape, isopencv=False):
...
def expand_mask(bbox, mini_mask, image_shape, isopencv=False):
    """Resizes mini masks back to image size. Reverses the change
    of minimize_mask().NOT USE
...
def unmold_mask(mask, bbox, image_shape, isopencv=False):
...
def unmold_part(part, bbox, image_shape):
    ...
    to it's original shape.NOT USE
