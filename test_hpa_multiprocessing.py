...
# modified 1
name = "models.hpa_resfpn_c5d_edgamf512_e357_part357_partse"
...
class InferenceConfig(module.HPAConfig):
    ...
    # modified 2
    PROCESS_NAME = "val_hpa_20191201a_epoch033"  # for tmp tested image name
    GPU_COUNT = 1  # only 1
    PROCESS_COUNT = 3
...
if MACHINE_NAME == "Jason":
    ...
    # modified 3
    MODEL_PATH = "/home/sk49/workspace/zhoudu/ATEN/outputs/hpa_20191201a/checkpoints" + "/" + \
                 "parsing_rcnn_hpa_20191201a_epoch033_loss1.211_valloss1.383.h5"
    # modified 4
    RES_DIR = "./vis_hpa/val_hpa_20191201a_epoch033"
    # modified 5
    gpus = ["1"]
    IMAGE_DIR = DATASET_DIR + "/Images"
