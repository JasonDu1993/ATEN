...
# modified 1
name = "models.hpa_resfpn_c5d_edpsef256_e357_part357_partse"
...
class InferenceConfig(module.HPAConfig):
    ...
    # modified 2
    PROCESS_NAME = "val_hpa_20191201b_epoch022"  # for tmp tested image name
    GPU_COUNT = 1  # only 1
    PROCESS_COUNT = 3
...
if MACHINE_NAME == "Jason":
    ...
    # modified 3
    MODEL_PATH = "/home/sk49/workspace/zhoudu/ATEN/outputs/hpa_20191201b/checkpoints" + "/" + \
                 "parsing_rcnn_hpa_20191201b_epoch022_loss0.946_valloss1.124.h5"
    # modified 4
    RES_DIR = "./vis_hpa/val_hpa_20191201b_epoch022"
    # modified 5
    gpus = ["1"]
    IMAGE_DIR = DATASET_DIR + "/Images"
