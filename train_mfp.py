...
from models.mfp_resfpn_c5d_edgamf256_e357_part357_partse_image_3d3igru import MFPNet, MFPConfig
...
if MACHINE_NAME == "Jason":
    ...
    # PRETRAIN_MODEL_PATH = "/home/sk49/workspace/zhoudu/ATEN/outputs/mfp_20191203a/checkpoints" + "/" + \
    #                       "parsing_rcnn_mfp_20191203a_epoch005_loss1.399_valloss1.645.h5"
    # PRETRAIN_MODEL_PATH = os.path.join(ROOT_DIR, "checkpoints", "parsing_rcnn.h5")
